...
public class MoreVillagerTrades {
    ...
    private static void ButcherTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.BUTCHER, 3, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.COOKED_RABBIT, 5), 16, 10, 0.05F)));

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.BUTCHER, 4, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.MUTTON, 5), 16, 15, 0.05F)));

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.BUTCHER, 5, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.COOKED_BEEF, 5), 12, 30, 0.05F)));
    }
    ...
    private static void ClericTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.CLERIC, 2, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.GUNPOWDER, 16), new ItemStack(Items.EMERALD), 12, 10, 0.05F)));
    ...
    private static void FarmerTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 4, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.BROWN_MUSHROOM, 32), new ItemStack(Items.EMERALD), 12, 30, 0.05F));
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.RED_MUSHROOM, 32), new ItemStack(Items.EMERALD), 12, 30, 0.05F));
        });
    ...
    private static void MasonTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.MASON, 3, factories -> {
            ...
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.PRISMARINE), 12, 10, 0.05F));
        });

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.MASON, 4, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.PRISMARINE, 8), Optional.of(new TradedItem(Items.EMERALD)), new ItemStack(Items.DARK_PRISMARINE, 8), 16, 30, 0.05F)));
    ...
    private static void ShepherdTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.SHEPHERD, 3, factories -> factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 8), new ItemStack(Items.WOLF_ARMOR), 3, 20, 0.05F)));
    }
