...
public class VillagerTrades {
    private static void ArmorerTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.ARMORER, 2, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.COPPER_INGOT, 4), new ItemStack(Items.EMERALD), 12, 10,0.05F));
        });
    }

    private static void ButcherTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.BUTCHER, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.COOKED_RABBIT, 5), 16, 5,0.05F));
        });

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.BUTCHER, 4, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.MUTTON, 5), 16, 5,0.05F));
        });
    ...
    private static void ClericTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.CLERIC, 2, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.GUNPOWDER, 16), new ItemStack(Items.EMERALD), 12, 5,0.05F));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.CLERIC, 5, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 8), new ItemStack(Items.PHANTOM_MEMBRANE), 12, 30,0.2F));
        });
    }
    ...
    private static void FarmerTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.MOSS_BLOCK, 16), new ItemStack(Items.EMERALD), 12, 15,0.05F));
        });
    ...
    private static void FishermanTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FISHERMAN, 1, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 2), new ItemStack(Items.WATER_BUCKET), 16, 1,0.05F));
        });
    ...
    private static void FletcherTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FLETCHER, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.SPECTRAL_ARROW, 8), 12, 10,0.05F));
        });

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FLETCHER, 5, factories -> {
            factories.add(new TradeOffers.SellPotionHoldingItemFactory(Items.SPECTRAL_ARROW, 5,Items.TIPPED_ARROW, 5, 1, 12, 30));
        });
    }
    ...
    private static void LeatherWorkerTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.LEATHERWORKER, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 2), new ItemStack(Items.BUNDLE), 3, 10,0.05F));
        });
    ...
    private static void LibrarianTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.LIBRARIAN, 1, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.BAMBOO, 48), new ItemStack(Items.EMERALD), 16, 2,0.05F));
        });

        TradeOfferHelper.registerVillagerOffers(VillagerProfession.LIBRARIAN, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.GLOW_INK_SAC, 4), new ItemStack(Items.EMERALD), 12, 20,0.05F));
        });
    ...
    private static void MasonTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.MASON, 5, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD), new ItemStack(Items.QUARTZ_BRICKS), 12, 30,0.05F));
        });
    }

    private static void ShepherdTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.SHEPHERD, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 8), new ItemStack(Items.WOLF_ARMOR), 3, 30,0.05F));
        });
    }
    ...
    private static void ToolSmithTrades() {
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.TOOLSMITH, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 2), new ItemStack(Items.IRON_HOE), 3, 10,0.2F));
        });
    }

    private static void WeaponSmithTrades() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.WEAPONSMITH, 1, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 1), new ItemStack(Items.SHIELD), 12, 1,0.2F));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.WEAPONSMITH, 3, factories -> {
            factories.add((entity, random) -> new TradeOffer(new TradedItem(Items.EMERALD, 2), new ItemStack(Items.FLINT_AND_STEEL), 12, 10,0.05F));
        });
    }
